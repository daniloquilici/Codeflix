...
namespace quilici.Codeflix.Catalog.UnitTest.Application.Genre.CreateGenre
{
    ...
    {
        public CreateGenreInput GetExampleInput() => new CreateGenreInput(GetValidGenreName(), GetRandomBoolean());

        public CreateGenreInput GetExampleInput(string? name) => new CreateGenreInput(name!, GetRandomBoolean());
